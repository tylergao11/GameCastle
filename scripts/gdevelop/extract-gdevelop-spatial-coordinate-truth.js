...
var SOURCE_MANIFEST = require('../../packages/gdjs/generated/gdevelop-codegen-source.json');
var SPATIAL_SOURCE = require('../../packages/gdjs/generated/spatial-coordinate-source.json');
var PROJECT_DEFAULTS = require('../../packages/gdjs/generated/project-defaults.json');
var OUT = path.join(ROOT, 'packages', 'gdjs', 'generated', 'spatial-coordinate-truth.json');
...
if (CHECK) {
  if (!fs.existsSync(OUT) || fs.readFileSync(OUT, 'utf8') !== serialized) throw new Error('GDevelop spatial coordinate truth drifted. Run node scripts/gdevelop/extract-gdevelop-spatial-coordinate-truth.js');
