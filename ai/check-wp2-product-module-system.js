...
async function main() {
  ...
  try {
    ...
    var continued = await runtime.continue(Object.assign({}, request, { requestId: 'wp2-system-2' }), { workspaceRoot: root });
