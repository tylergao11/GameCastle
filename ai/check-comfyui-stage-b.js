...
(async function() {
  ...
  try {
    ...
    process.env.ASSET_MODEL_PROVIDER = 'comfyui-local'; process.env.ASSET_IMAGE_MODEL = 'gamecastle.sprite-edit.dev-cpu.v1'; process.env.ASSET_VISION_MODEL = 'gamecastle.asset-review.dev-cpu.v1'; process.env.COMFYUI_ALLOW_LOCAL = 'true'; process.env.COMFYUI_ENDPOINT = 'http://127.0.0.1:8188'; process.env.COMFYUI_MODEL_PATH = model; process.env.COMFYUI_MODEL_SHA256 = digest(fs.readFileSync(model)); process.env.COMFYUI_IMAGE_MODEL = 'gamecastle.sprite-edit.dev-cpu.v1'; process.env.COMFYUI_VISION_MODEL = 'gamecastle.asset-review.dev-cpu.v1'; process.env.COMFYUI_FLORENCE2_MODEL_PATH = florence; process.env.COMFYUI_FLORENCE2_MODEL_SHA256 = comfy._hashPath(florence); process.env.COMFYUI_ROOT = path.resolve('.tools/ComfyUI'); process.env.COMFYUI_TRANSIT_DIR = path.join(root, 'transit'); process.env.COMFYUI_POLL_MS = '1';
