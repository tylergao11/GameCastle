var ROLE_DEFINITIONS = {
  ...
  dsl: {
    ...
    purpose: 'Compile creative intent and ProjectWorld into Module DSL patches.',
    modality: 'text',
  ...
  dslModuleRepair: {
    id: 'dslModuleRepair',
    label: 'DSLModuleRepair',
    owner: 'LLM2',
    contractOwner: 'DSLAgent',
    purpose: 'Repair Module DSL that failed before execution.',
    modality: 'text',
  ...
  dslInternalRepair: {
    ...
    owner: 'LLM2',
    contractOwner: 'DSLAgent',
    purpose: 'Repair failed internal low-level DSL batches from ExecutionReport.',
    modality: 'text',
