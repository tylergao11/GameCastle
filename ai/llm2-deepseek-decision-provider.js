...
function stablePrefix() {
  return [
    ...
    'Output slots:',
    'decisionType is required and uses the declared domain.',
    'intentDslLines and requestedContext are arrays.',
    'reason is a short string. confidence is a number from zero through one.',
    'intentDslLines is populated only for apply_intent.',
