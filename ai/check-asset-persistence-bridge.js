...
async function main() {
  ...
  try {
    ...
    var result = await bridge.persistAcceptedGeneratedAsset({ persistenceMode: 'verification-staging', familyId: 'asset-family.hero', candidate: { status: 'generated', materialized: true, path: file, sha256: digest, format: 'png', styleId: 'gamecastle.style-1', semanticTags: ['hero'], width: 32, height: 32, transparent: true, providerReceipt: { provenance: { provider: 'comfyui-local', workflowId: 'pixel-sprite', workflowRevision: 'v1', workflowSha256: 'a'.repeat(64), modelId: 'local-model', modelSha256: 'b'.repeat(64), licenseId: 'internal-model-license', jobId: 'job-7' } } } });
    ...
    await assert.rejects(function() { return bridge.persistAcceptedGeneratedAsset({ persistenceMode: 'verification-staging', familyId: 'asset-family.bad', candidate: { status: 'generated', materialized: true, path: file, sha256: 'c'.repeat(64), format: 'png', styleId: 'gamecastle.style-1', providerReceipt: { provenance: { provider: 'comfyui-local', workflowId: 'pixel-sprite', workflowRevision: 'v1', workflowSha256: 'a'.repeat(64), modelId: 'local-model', modelSha256: 'b'.repeat(64), licenseId: 'internal-model-license', jobId: 'job-8' } } } }); }, /candidate sha256/);
    await assert.rejects(function() { return bridge.persistAcceptedGeneratedAsset({ persistenceMode: 'verification-staging', familyId: 'asset-family.private', candidate: { status: 'generated', materialized: true, privacyScope: 'private-local', path: file, sha256: digest, format: 'png', styleId: 'gamecastle.style-1', providerReceipt: { provenance: { provider: 'comfyui-local', workflowId: 'pixel-sprite', workflowRevision: 'v1', workflowSha256: 'a'.repeat(64), modelId: 'local-model', modelSha256: 'b'.repeat(64), licenseId: 'internal-model-license', jobId: 'job-9' } } } }); }, /private-local candidates/);
    await assert.rejects(function() { return bridge.persistAcceptedGeneratedAsset({ familyId: 'asset-family.missing-mode', candidate: { status: 'generated', materialized: true, path: file, sha256: digest, format: 'png', styleId: 'gamecastle.style-1', providerReceipt: { provenance: { provider: 'comfyui-local', workflowId: 'pixel-sprite', workflowRevision: 'v1', workflowSha256: 'a'.repeat(64), modelId: 'local-model', modelSha256: 'b'.repeat(64), licenseId: 'internal-model-license', jobId: 'job-10' } } } }); }, /persistenceMode=verification-staging/);
