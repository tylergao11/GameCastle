...
function defaultStablePrefix() {
  return [
    ...
    'You only reason in gameplay intent, not engine target code.',
    'Canonical output surface: apply_intent, request_context, no_op, reject.',
    'Intent DSL examples:',
    'make a mobile platformer',
    'place coins near Player front as trail count 5',
    'reduce enemy pressure near Player early route',
    'add joystick controls Player near screen bottom-left',
    'add jump button controls Player near screen bottom-right',
    'Rules:',
    '- Never output coordinates, component ids, GDJS names, adapter ids, bridge plans, JSON, or explanations.',
