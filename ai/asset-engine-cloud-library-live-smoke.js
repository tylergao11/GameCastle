...
var supabaseAssetLibrary = require('./asset-library-supabase-port');
...
function requirements() {
  return {
    ...
    requirements: [{
      semanticId: staticId,
      subject: 'blue gem',
      description: 'Single small blue gem game icon, centered, flat vector game art, transparent background, no text.',
      roles: ['gem', probeId],
      gdjsBindings: [],
      ...
      subject: 'blue gem',
      description: 'Single small blue gem idle animation, centered, flat vector game art, plain light background, no text.',
...
function input(runId, projectId, projectAssetDir, libraryPort, runtime) {
  return {
    ...
    providerOptions: { provider: 'comfyui-local', estimatedCost: 0, timeoutMs: 600000 },
