...
var UNIVERSE_PATH = path.join(__dirname, '..', '..', 'gdjs', 'generated', 'capability-universe.json');
var OFFICIAL_BINDINGS_PATH = path.join(__dirname, '..', '..', 'gdjs', 'generated', 'official-capability-bindings.json');
var EVENT_GRAMMAR_PATH = path.join(__dirname, '..', '..', 'gdjs', 'generated', 'event-grammar.json');
var SEMANTIC_INDEX_PATH = path.join(__dirname, '..', 'generated', 'capability-semantic-index.json');
var OBJECT_CONFIGURATION_TRUTH_PATH = path.join(__dirname, '..', '..', 'gdjs', 'generated', 'object-configuration-truth.json');
var LAYOUT_DICTIONARY_PATH = path.join(__dirname, '..', 'contracts', 'semantic-layout-dictionary.json');
var ASSET_BINDING_DICTIONARY_PATH = path.join(__dirname, '..', '..', 'gdjs', 'contracts', 'gdjs-asset-binding-dictionary.json');
...
function componentEntries(catalog) {
  ...
  catalog.components.forEach(function(component) {
    ...
    byComponent[component.id] = {
      ...
      source: { kind: 'component-manifest', path: 'packages/semantic/components/' + component.sourceFile }
    };
  });
  return byComponent;
}
