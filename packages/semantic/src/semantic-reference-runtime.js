...
var production = require('../../assets/contracts/asset-production-pipeline-contract.json');
var styles = require('../../assets/contracts/asset-style-dictionary.json');
...
module.exports = { CAPABILITY_KINDS: CAPABILITY_KINDS, EXTENSION_KINDS: EXTENSION_KINDS, TASK_CATALOGS: TASK_CATALOGS, create: create };
