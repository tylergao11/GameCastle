...
var profiles = require('../contracts/asset-engine-execution-profiles.json');
var workflowRegistry = require('../contracts/comfyui-workflow-registry.json');
var productionContract = require('../contracts/asset-production-pipeline-contract.json');
