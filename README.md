...
- [Playable Runtime Architecture](docs/playable-runtime-architecture.md)
- [Playable Runtime Terra Handoff](docs/playable-runtime-terra-handoff.md)
- [Asset Production Pipeline Contract](shared/asset-production-pipeline-contract.json)
- [ComfyUI Asset Production Loop](docs/comfyui-asset-production-pipeline.md)
