...
| Semantic Engine | CreativeVision、Intent、BuildContract | 安全 ProjectWorld、Playtest evidence | 读取目标代码、资产原图、直接修改 Runtime |
| ProductModuleCompiler | 模块匹配与目标玩法展开 | BuildContract、模块词典 | 让 LLM 输出模块实现、临时修项目 |
