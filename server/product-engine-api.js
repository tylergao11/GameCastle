...
var semanticExecutor = require('../ai/semantic-product-executor');
var productOrchestratorApi = require('../ai/product-delivery-orchestrator');
...
if (require.main === module) {
  ...
  var storageRoot = path.resolve(process.env.PRODUCT_ENGINE_STORAGE_ROOT || path.join(__dirname, '..', 'output', 'product-deliveries'));
