...
(async function() {
  ...
  try {
    ...
    var sourceHashes = [], reviewCalls = 0, semanticCalls = 0;
    ...
    var orchestrator = orchestratorApi.create({ storageRoot: root, index: index, budgets: { semanticCycles: 2, stageAttemptsPerSource: { asset: 1, spatial: 1, assembly: 1 }, repeatedObservationLimit: 2, elapsedMs: 60000, costUsd: 1 }, providerRuntime: { listReceipts: function() { return []; } }, semanticRuntime: fakeSemantic, assetPipeline: fakeAsset, spatialPipeline: fakeSpatial, browserCapture: fakeCapture, assemblyReviewer: fakeReviewer });
